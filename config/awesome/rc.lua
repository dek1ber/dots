...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ " ", "2", " ", "4", "5", "6", "7", "8", " " }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer sset 'Master' 10%+ && canberra-gtk-play -i audio-volume-change", false) end),
    awful.key({}, "XF86AudioLowerVolume", function () awful.util.spawn("amixer sset 'Master' 10%-", false) end),
    ...
    --awful.key({}, "XF86AudioMute", function () awful.util.spawn("pactl set-sink-mute @DEFAULT_SINK@ toggle", false) end),
    --awful.key({}, "XF86AudioMute", function () awful.util.spawn("pactl set-sink-mute @DEFAULT_SINK@ toggle", false) end),
     awful.key({}, "XF86AudioMicRaiseVolume", function () awful.util.spawn("amixer sset 'Capture' 10%+", false) end),
    awful.key({}, "XF86AudioMicLowerVolume", function () awful.util.spawn("amixer sset 'Capture' 10%-", false) end),
